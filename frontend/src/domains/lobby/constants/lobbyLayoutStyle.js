...
export const LOBBY_LOGO_CLASS = "pointer-events-none h-auto w-[clamp(14rem,27vw,28rem)] translate-y-[clamp(0.4rem,1.2vh,0.9rem)] select-none"
...
// 오른쪽 아래 친구 목록 버튼과 사운드 조절 UI가 들어가는 영역입니다.
