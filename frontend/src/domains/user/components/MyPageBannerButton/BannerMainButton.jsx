import BannerProfilePortrait from "@/domains/user/components/MyPageBannerButton/BannerProfilePortrait.jsx"
...
export default function BannerMainButton({
  onClick,
  bannerSrc,
  showText,
  ...
  return (
    ...
    >
      ...
      {showProfilePortrait ? <BannerProfilePortrait /> : null}
