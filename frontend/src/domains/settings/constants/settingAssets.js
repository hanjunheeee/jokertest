...
export const SETTING_ASSETS = {
  bgVideo: "/bg/로비 설정창 영상2.mp4".normalize("NFD"),
  tabActive: "/button/옵션버튼(활성화).png".normalize("NFD"),
  tabInactive: "/button/옵션버튼(비활성화).png".normalize("NFD"),
  inputField: "/button/입력창1.png",
  checkbox: "/button/체크박스2.png".normalize("NFD"),
  checkMark: "/button/체크표시.png".normalize("NFD"),
  arrow: "/button/이동 화살표.png".normalize("NFD"),
  scrollTrack: "/frame/빈 스크롤바.png",
  scrollThumb: "/frame/스크롤 롤러.png".normalize("NFD"),
  actionButton: "/button/버튼(수락 및 긍정).png".normalize("NFD"),
}
