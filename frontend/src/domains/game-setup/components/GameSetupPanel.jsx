...
const TAB_BTN_CLASS =
  "relative w-[clamp(21rem,45vw,27rem)] shrink-0 cursor-pointer border-0 bg-transparent p-0 leading-none transition-opacity hover:opacity-90"
...
const SETUP_CONTENT_CLASS =
  "flex min-h-0 flex-1 flex-col overflow-hidden pr-0.5 pt-[clamp(4rem,5vh,6rem)]"

const CREATE_GAME_BTN_CLASS =
  "relative mx-auto mt-[clamp(0.55rem,1.2vh,0.85rem)] block w-[clamp(13.5rem,20vw,17.5rem)] shrink-0 cursor-pointer border-0 bg-transparent p-0 leading-none transition-opacity hover:opacity-90"
