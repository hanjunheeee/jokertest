...
export default function MultiplayRoomListArea({ rooms = DUMMY_MULTIPLAY_ROOMS, onCreateGame, onJoinByCode }) {
  return <RoomListShell rooms={rooms} onCreateGame={onCreateGame} onJoinByCode={onJoinByCode} />
}
